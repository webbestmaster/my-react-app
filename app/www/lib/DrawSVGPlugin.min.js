...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    function i(e, r) {
        if (!e)return [0, 0];
        e = t(e), r = r || o(e) + 1;
        var i = s(e), n = i.strokeDasharray || "", a = parseFloat(i.strokeDashoffset), h = n.indexOf(",");
    ...
    var n, s = document.defaultView ? document.defaultView.getComputedStyle : function () {
        }, a = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi, h = "codepen", f = "DrawSVGPlugin", d = "", l = "", g = function (e) {
    ...
    n = _gsScope._gsDefine.plugin({
        propName: "drawSVG", API: 2, version: "0.1.1", global: !0, overwriteProps: ["drawSVG"], init: function (e, t, n, s) {
